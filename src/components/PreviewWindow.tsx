...
const PreviewWindow = () => {
  ...
  return <div className="w-full max-w-4xl mx-auto dark-glass rounded-xl overflow-hidden animate-fade-in">
      <div className="border-b border-white/10 py-4 flex justify-between items-center mx-0 px-[23px]">
        ...
        <Tabs defaultValue="original" className="w-full">
          ...
          <TabsContent value="original" className="mt-0">
            <div className="rounded-xl overflow-hidden border border-white/10 bg-black/30">
              <img src="/lovable-uploads/24f0488e-4382-413c-9bff-b91a62213a9b.png" alt="Original document" className="w-full max-h-[500px] object-contain" />
            </div>
          </TabsContent>
