...
const HowToSection: React.FC<HowToSectionProps> = ({
  ...
  return <section id="how-it-works" className="py-24 px-6 bg-black/40" ref={el => addToRefs(el, 3)}>
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="rounded-xl overflow-hidden border-2 border-primary/20 p-2 transition-transform duration-300 hover:scale-105">
            <img src="/lovable-uploads/82b29139-f988-4210-abd5-bedf1ede28d8.png" alt="Text extraction steps" className="w-full h-auto rounded-lg" />
          </div>
          ...
          }].map(step => <div key={step.number} className="flex gap-6 transition-transform duration-300 hover:scale-105 p-4 bg-neutral-600 rounded-xl">
